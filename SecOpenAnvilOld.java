...
public class SecOpenAnvilOld extends OptionalSection {

	static {
		Skript.registerCondition(SecOpenAnvilOld.class, "open [an] anvil [gui] (named|with title) %string% to %players% with [items] %itemtypes%");
	}
