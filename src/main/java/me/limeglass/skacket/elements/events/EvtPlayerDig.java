...
public class EvtPlayerDig extends SkriptEvent {
	...
	static {
		Skript.registerEvent("player dig", EvtPlayerDig.class, PlayerBlockDigEvent.class, "[player] [(1¦start|2¦stop|3¦abandon)] block dig[ging] [(for|of) %itemtypes%]", "player release (use item|(right mouse button|right[(-| )]click))")
